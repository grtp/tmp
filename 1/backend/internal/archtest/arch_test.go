...
var allowed = map[string][]string{
	"cmd/server": {"gen/api", "internal/appdb", "internal/audit", "internal/auth",
		...
		"internal/store"},
	"internal/httpapi": {"gen/api", "internal/audit", "internal/auth",
		"internal/auth/adguid", "internal/authz", "internal/conn", "internal/meta",
		"internal/repo", "internal/session", "internal/store"},
	"internal/audit":       {"internal/appdb", "internal/auth/adguid"},
	...
	"internal/repo":        {"internal/appdb", "internal/auth/adguid", "internal/authz", "internal/meta"},
	"internal/session":     {"internal/auth/adguid"},
	"internal/store":       {"internal/appdb", "internal/meta"},
	"internal/appdb":       {},
