...
// ForbiddenError -> 403 forbidden (guards: denyInsert / denyDelete)
...
// ProtectError -> 409 conflict (guards.protect: lastRowMatching)
type ProtectError struct{ Msg string }

func (e *ProtectError) Error() string { return e.Msg }
