...
export class FilterBar {
  ...
  /** アンカー要素の真下のビューポート座標(横は画面内にクランプ)。 */
  private anchorPos(el: HTMLElement | null): { left: number; top: number } {
