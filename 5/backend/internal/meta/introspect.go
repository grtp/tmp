...
// RegisteredKey builds the exclusion-set key for ListCandidates.
...
// ListCandidates lists BASE TABLEs that can be registered on the given
// target db: excludes app_% tables and everything in `registered`.
//
