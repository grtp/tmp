...
const connections = [
  { id: 1, name: '生産管理DB', host: 'db2.example.local', port: 1433, databaseName: 'seisan', username: 'svc_forge', enabled: true },
  { id: 2, name: '検証環境DB', host: 'db-test.example.local', port: 1433, databaseName: 'sandbox', username: 'svc_forge', enabled: false },
];
