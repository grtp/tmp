...
const entries: HistoryRow[] = [
  {
    ...
    target: 'dbo.products',
    detailText: JSON.stringify({ inserted: 1, updated: 2, deleted: 0, insertedKeys: [{ id: 6 }] }, null, 2),
    hasOverflow: false,
    result: 'success',
  ...
  },
  {
    ...
    operation: 'rows.batch',
    target: 'dbo.products',
    detailText: JSON.stringify({ updates: 1, error: 'row_version_mismatch' }, null, 2),
    hasOverflow: false,
    result: 'failure',
    errorCode: 'conflict',
  ...
  },
  {
    ...
    operation: 'rows.batch',
    target: 'dbo.bigdata',
    detailText: JSON.stringify({ truncated: true, reason: 'detail exceeds 1MB', overflowKey: 'audit-overflow/xxxx.json' }, null, 2),
    hasOverflow: true,
    result: 'success',
    clientIp: '192.168.1.10',
  },
