...
const itemRows: TableRow[] = [
  { code: 'A-10021', name: '原料アルミ板 t1.2', category: '原料', updatedAt: '2026-07-01' },
  { code: 'A-10022', name: '原料アルミ板 t2.0', category: '原料', updatedAt: '2026-06-28' },
  { code: 'B-20515', name: '中間品ユニットB', category: '中間品', updatedAt: '2026-06-15' },
  { code: 'B-20516', name: '中間品ユニットC', category: '中間品', updatedAt: '2026-06-12' },
  { code: 'C-30801', name: '完成品パネルA型', category: '完成品', updatedAt: '2026-06-10' },
];
...
export const ProcessMaster: Story = {
  args: {
    ...
    rows: [
      { processCode: 'P-001', processName: '切断', line: 'L1', owner: '製造1課', updatedAt: '2026-06-30' },
      { processCode: 'P-002', processName: 'プレス成形', line: 'L1', owner: '製造1課', updatedAt: '2026-06-22' },
      { processCode: 'P-010', processName: '表面処理', line: 'L2', owner: '製造2課', updatedAt: '2026-06-18' },
    ],
    totalCount: 42,
  },
};
