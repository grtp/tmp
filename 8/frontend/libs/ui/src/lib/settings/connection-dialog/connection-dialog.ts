...
/** ConnectionDialogData は開く側(コンテナ)が渡す初期値。 */
 ...
 * 規約: 自分では API を呼ばず saved/testClicked を emit するだけ。
 * saving/testing/errorMessage/testResult はコンテナが componentRef.setInput
 * で更新する(ダイアログを開いたまま結果を出すため)。
 */
@Component({
