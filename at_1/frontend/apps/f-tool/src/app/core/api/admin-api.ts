...
import { Action, AuthAssignment, Connection, ConnectionCreate, ConnectionTestResult, ConnectionUpdate, FixedColumn, HistoryPage, ManagedTable, SchemaTable, SchemaTablePreview, UserWithAuth, } from '../models';
...
export class AdminApi {
    ...
    updateManagedTable(id: number, body: Partial<Pick<ManagedTable, 'displayName' | 'slug' | 'description' | 'sortOrder' | 'enabled' | 'readonlyColumns' | 'hiddenColumns' | 'fixedColumns'>>): Promise<ManagedTable> {
